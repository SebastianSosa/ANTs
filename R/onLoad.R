...
.onAttach <- function(...) {
  		...
  		packageStartupMessage("For citation information, type: citation('ANTs')")
  		packageStartupMessage("For more information, visit our websites:")
  		packageStartupMessage("    - www.s-sosa.com/ants")
  		packageStartupMessage("    - https://github.com/SebastianSosa/ANTs")
  		packageStartupMessage("Authors: Sebastian Sosa, Ivan Puga-Gonzalez, Hu Feng He, Jerome Pansanel, Xiaohua Xie, Cedric Sueur")
  }
