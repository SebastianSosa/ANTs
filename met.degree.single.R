...
#' @description Calculate for all the vertices the node metric calldegree.
...
#' @details  met.degree of vertice \emph{i} is the number of edges of \emph{i}, its also represent the number of his of alters.
